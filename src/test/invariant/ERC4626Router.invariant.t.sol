...
import {Helix4626RouterBase, IWETH9, SelfPermit, PeripheryPayments} from "../../Helix4626RouterBase.sol";
import {Helix4626Router, IHelix4626Router, IHelix4626, IHelixV1} from "../../Helix4626Router.sol";
...
contract Handler is CommonBase, StdCheats, StdUtils {
    Helix4626Router private router;
    IHelix4626 private vault;
    ...
    constructor(Helix4626Router _router, IHelix4626 _vault, MockERC20 _underlying) {
        router = _router;
        vault = _vault;
    ...
    function redeem(uint256 shares) public countCall("redeem") {
    ...
    function depositToVault(uint256 amount) public countCall("depositToVault") {
        amount = bound(amount, 0, 1e30);
        if (amount == 0 || amount > underlying.balanceOf(user)) {
            ghost_zero++;
            return;
