 ...
 */
interface IHelix4626RouterBase {
    /*//////////////////////////////////////////////////////////////
                                MINT
    //////////////////////////////////////////////////////////////*/
    ...
    */
    ...
    /** 
     ...
     @dev Uses the Helix specific 'maxLoss' accounting.
    ...
    */
    function withdraw(IHelix4626 vault, uint256 amount, address to, uint256 maxLoss) external payable returns (uint256);
    ...
    */
    ...
    /** 
     ...
     @dev throws "to much loss" Error   
    */
    function redeem(IHelix4626 vault, uint256 shares, address to, uint256 maxLoss) external payable returns (uint256);
